            ...
            <div className="flex flex-wrap">
              <div className="w-full lg:w-12/12 px-4">
                ...
                <form onSubmit={onSubmit}>
                  <div className="rounded-t bg-white mb-0 px-6 py-6">
                    <div className="text-center flex justify-between">
                      <h6 className="text-blueGray-700 text-xl font-bold">My Documents</h6>
                      <button
                        className="bg-blueGray-700 active:bg-blueGray-600 text-white font-bold uppercase text-xs px-4 py-2 rounded shadow hover:shadow-md outline-none focus:outline-none mr-1 ease-linear transition-all duration-150"
                        type="submit"
                      >
                  ...
                  <div className="flex flex-wrap">
                    ...
                    <div className="w-full lg:w-6/12 px-8">
                      <label                     className="block uppercase text-blueGray-600 text-xs font-bold mb-8"
>Tittle document</label>
                      <input
                        type="text"
                        className="border-1 px-4 py-3 placeholder-blueGray-300 text-blueGray-600 bg-white rounded text-sm shadow focus:outline-none focus:ring w-full ease-linear transition-all duration-150"
                  ...
                  <div className="w-full lg:w-6/12 px-8">
                    ...
                    <input
                      type="text"
                      className="border-1 px-2 py-3 placeholder-blueGray-300 text-blueGray-600 bg-white rounded text-sm shadow focus:outline-none focus:ring w-full ease-linear transition-all duration-150"
                      placeholder="Type here"
                      id="product_price"
                      required
                  ...
                  <div className="flex flex-wrap">
                    <div className="w-full lg:w-12/12 px-8">
                      <div className="relative w-full mb-3">
                        ...
                        <textarea
                          placeholder="Type here"
                          className="border-1 px-3 py-6 placeholder-blueGray-300 text-blueGray-600 bg-white rounded text-sm shadow focus:outline-none focus:ring w-full ease-linear transition-all duration-150"
                          rows="7"
                          required
